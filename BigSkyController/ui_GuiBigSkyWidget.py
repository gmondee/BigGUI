...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_3.addWidget(self.laserSaveButton)
        ...
        sizePolicy.setHeightForWidth(self.flashLampVoltageLineEdit.sizePolicy().hasHeightForWidth())
        self.flashLampVoltageLineEdit.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(14)
