...
from PyQt6.QtWidgets import QApplication, QMainWindow, QTabWidget, QLabel, QWidget, QFrame, QVBoxLayout, QHBoxLayout, QLineEdit, QPushButton,QFormLayout, QSlider
import time
...
class LaserControlGUI(QMainWindow):
    ...
    def handle_set_rep_rate(self):
        ...
        try:
            rate = int(float(rate))
            self.laser.set_rep_rate(rate)
        except:
            print("Viron: Invalid repetition rate")
            return
    ...
    def create_gui(self):
        ...
        first_tab_layout.setAlignment(Qt.AlignmentFlag.AlignTop)  # Align contents to the top
        ...
        self.laser_status_label.setAlignment(Qt.AlignmentFlag.AlignVCenter)
        self.laser_status_label.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        
        critical_status_label = QLabel("Status:")
        critical_status_label.setAlignment(Qt.AlignmentFlag.AlignVCenter)
        critical_status_label.setAlignment(Qt.AlignmentFlag.AlignRight)
...
if __name__ == "__main__":
    ...
    try:
        gui = LaserControlGUI(host='192.168.103.103', port=23, password='VR'+'E63BB7')
        ret = app.exec()
        gui.on_close()
        sys.exit(ret)     
